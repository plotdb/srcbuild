...
var fs, path, fsExtra, pug, livescript, stylus, jsYaml, marked, crypto, colors, minify, base, aux, bundle, hashstore, cwd, libpug, pugbuild;
fs = require('fs');
path = require('path');
...
pugbuild.prototype = import$(Object.create(base.prototype), {
  checkLibpug: function(){
    ...
    try {
      theirs = require.resolve(libpug.replace(/^@\//, ''), {
        paths: [this.base]
      });
    } catch (e$) {
      e = e$;
      return this.log.warn(("cannot resolve " + libpug + " from " + this.base + ": " + e.message).yellow);
    }
